...
execute unless entity @e[type=armor_stand,sort=nearest,tag=elev_marker,limit=1,distance=..0.5] at @e[type=minecraft:armor_stand,tag=elev_move,limit=1,sort=nearest] align xz positioned ~0.5 ~ ~0.5 run function elevator:teleport/move_up
